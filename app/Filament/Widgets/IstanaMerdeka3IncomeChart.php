...
class IstanaMerdeka3IncomeChart extends ChartWidget
{
    protected static ?string $heading = 'Grafik Pendapatan Istana Merdeka 3';
    ...
    protected function getData(): array
    {
        ...
        // Filter Spesifik untuk Istana Merdeka 3
        $query = Finance::query()
            ->where('type', 'income')
            ->whereHas('gymkos', function (Builder $q) {
                $q->where('name', 'Istana Merdeka 3'); 
            });
        ...
        return [
            'datasets' => [
                [
                    ...
                    'borderColor' => '#8b5cf6', // Warna Ungu (Purple)
                    'fill' => 'start',
                    'tension' => 0.3,
                ],
            ],
