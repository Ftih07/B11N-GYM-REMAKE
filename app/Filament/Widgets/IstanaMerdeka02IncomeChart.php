...
class IstanaMerdeka02IncomeChart extends ChartWidget
{
    protected static ?string $heading = 'Grafik Pendapatan Istana Merdeka 02 - Karang Wangkal';
    ...
    protected function getData(): array
    {
        ...
        // Filter Spesifik untuk Istana Merdeka 02
        $query = Finance::query()
            ->where('type', 'income')
            ->whereHas('gymkos', function (Builder $q) {
                $q->where('name', 'Istana Merdeka 02 - Karang Wangkal');
            });
