...
<body class="bg-dark text-gray-200 font-body min-h-screen flex flex-col">
    ...
    <div class="container mx-auto p-4 md:p-6 max-w-5xl flex-grow">
        ...
        {{-- Logic WA Link --}}
        @php
        $emailUser = auth()->user()->email ?? ($user->email ?? 'belum terdeteksi');
        $waMessage = "Halo Admin B1NG Empire, saya tidak bisa mengecek *riwayat absensi*. Email akun saya: *{$emailUser}* belum terdaftar di sistem. Mohon bantuannya untuk aktivasi.";
        ...
        <div class="text-center bg-yellow-900/20 border border-yellow-700/50 p-6 rounded-lg mt-6">
            ...
            <p class="text-gray-400 text-sm mb-5">Email ini belum terdaftar di sistem gym kami. Hubungi resepsionis untuk aktivasi.</p>
