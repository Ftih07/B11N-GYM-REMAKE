...
<head>
    ...
    <meta name="description"
        content="Temukan artikel terbaru seputar tips latihan fitness di B11N & K1NG Gym, panduan hidup sehat, serta info kost eksklusif Istana Merdeka 03.">

    {{-- Tambahan Keywords spesifik target lokal Purwokerto --}}
    <meta name="keywords"
        content="blog b1ng empire, tips fitness, artikel gym purwokerto, b11n gym, k1ng gym, kost eksklusif purwokerto, istana merdeka 03, gaya hidup sehat">
...
<body
    class="bg-gray-50 text-brand-black dark:bg-brand-black dark:text-gray-200 font-sans antialiased transition-colors duration-300 pt-20">
    ...
    {{-- HERO SECTION --}}
    <header class="relative w-full h-[100vh] flex items-center justify-center bg-gray-900 overflow-hidden">
        <div class="absolute inset-0 z-0">
            {{-- Optimasi: fetchpriority="high" untuk Hero Image --}}
            <img src="{{ asset('assets/Hero/b11ngym.jpg') }}" alt="Blog Background"
                class="w-full h-full object-cover opacity-50" fetchpriority="high" decoding="async">
        ...
        <div class="relative z-10 text-center px-4 max-w-4xl mx-auto">
            ...
            <h1
                class="text-white font-heading font-bold text-5xl md:text-7xl leading-tight mb-6 drop-shadow-2xl uppercase">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            @foreach ($blogs as $blog)
                <article
                    class="group bg-white dark:bg-brand-gray rounded-xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-gray-800 flex flex-col h-full">

                    <a href="{{ route('blogs.show', $blog->slug) }}" class="relative w-full h-64 overflow-hidden block">
                        {{-- Optimasi: loading="lazy" pada thumbnail artikel --}}
                        ...
                        <div
                            class="absolute top-4 left-4 bg-white/90 dark:bg-black/80 backdrop-blur px-3 py-1.5 rounded text-xs font-bold uppercase tracking-wider text-brand-black dark:text-white shadow-lg">
                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        <h3
                            class="text-xl font-heading font-bold text-gray-900 dark:text-white mb-3 line-clamp-2 leading-tight group-hover:text-brand-red transition-colors">
                        ...
                        <div
                            class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed mb-4 line-clamp-3 flex-grow">
                            {!! Str::limit(strip_tags($blog->content), 120) !!}
                        </div>

                        <a href="{{ route('blogs.show', $blog->slug) }}"
                            class="inline-flex items-center text-sm font-bold text-brand-orange hover:text-brand-red transition-colors mt-auto uppercase tracking-wide">
                            Baca Selengkapnya <i
