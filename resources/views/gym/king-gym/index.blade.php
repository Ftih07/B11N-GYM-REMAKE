...
<head>
    ...
    <meta name="description"
        content="K1NG Gym Purwokerto berlokasi di Ledug, Kembaran. Gym luas dengan fasilitas lengkap, free personal trainer, parkir gratis, dan harga mahasiswa mulai Rp 10rb.">
    <meta name="keywords"
        content="k1ng gym, gym ledug, fitness center kembaran, gym dekat ump, gym purwokerto, fitness murah purwokerto, member gym harian">
    ...
    <meta property="og:description"
        content="Pusat kebugaran di Ledug dengan alat lengkap, suasana nyaman, dan harga terjangkau. Gabung sekarang!">
...
<body>
                        ...
                        @foreach ($navMenus as $menu)
                            <div class="dropdown relative h-20 flex items-center group">
                                <a href="{{ route($menu['route']) }}"
                                    class="dropdown-toggle font-heading uppercase text-sm tracking-widest hover:text-brand-red transition-colors py-2 flex items-center gap-1 {{ Route::currentRouteName() === $menu['route'] ? 'text-brand-red font-bold' : 'text-gray-800 dark:text-white' }}"
    ...
    <section id="header">
        <header class="header">
            <div class="relative flex items-center justify-center h-screen bg-black text-white"
                style="background-image: linear-gradient(to right, rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.9)), url('assets/king-gym/hero.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
    ...
    <section class="max-w-[1200px] mx-auto px-4 sm:px-8 md:px-12 lg:px-16 py-20" id="about">
        <div class="about__header text-center">
            ...
            <p class="section__description mx-auto text-center text-base sm:text-base md:text-base">
                Selamat datang di K1NG Gym Purwokerto, pusat kebugaran populer di Ledug, Kec. Kembaran. Kami menawarkan
                keanggotaan harian, mingguan, dan bulanan dengan harga terjangkau. Fasilitas kami meliputi peralatan gym
                lengkap, loker yang aman, free personal trainer, dan free parkir. K1NG Gym bukan hanya tempat
                berolahraga, tapi juga ruang untuk membangun komunitas hidup sehat yang menyenangkan.
            </p>
        </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-center text-white rounded-full mx-auto -mb-16">
                            <img src="{{ asset('storage/' . $facility->image) }}" alt="{{ $facility->title }}"
                                class="object-cover w-28 h-28" loading="lazy" decoding="async" />
                        </div>
                ...
                @foreach ($featuredEquipments as $item)
                    ...
                    <div
                        ...
                        <div class="relative h-64 overflow-hidden bg-gray-100">
                            ...
                            <div
                                class="absolute top-0 left-0 bg-orange-500 text-white text-xs font-bold px-3 py-1 uppercase tracking-widest font-['Oswald']">
                                {{ $item->category }}
                            </div>
                            <div
                                ...
                                <a href="{{ route('gym.equipments.show', $item->slug) }}"
                                    class="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 font-bold uppercase tracking-wide transform translate-y-4 group-hover:translate-y-0 transition duration-300 shadow-lg flex items-center gap-2 rounded-sm">
                        ...
                        <div class="p-6">
                            <h3
                                class="text-2xl font-bold text-gray-900 mb-2 uppercase font-['Oswald'] group-hover:text-orange-500 transition-colors">
                                {{ $item->name }}
                            </h3>
                        ...
                        <div
                            class="h-1 w-0 group-hover:w-full bg-orange-500 transition-all duration-500 absolute bottom-0 left-0">
                        </div>
                    </div>
                @endforeach
            </div>
            ...
            @foreach ($trainer as $t)
                <div
                    ...
                    <img src="{{ asset('storage/' . $t->image) }}" alt="{{ $t->name }}"
                        class="h-50 w-full object-cover mb-4 rounded-md" loading="lazy" decoding="async" />
                    <h4 class="text-lg sm:text-xl md:text-2xl font-semibold">{{ $t->name }}</h4>
                    <p class="text-sm sm:text-base md:text-lg text-gray-600">{{ $t->description }}</p>
                    <div class="trainer__socials flex justify-center mt-4 gap-4">
                        <a href="{{ $t->urls['facebook'] ?? '#' }}"><i class="ri-facebook-fill"></i></a>
                        <a href="{{ $t->urls['whatsapp'] ?? '#' }}"><i class="ri-whatsapp-fill"></i></a>
                        <a href="{{ $t->urls['instagram'] ?? '#' }}"><i class="ri-instagram-fill"></i></a>
                    </div>
                </div>
            @endforeach
        </div>
    ...
    <section class="membership"
        style="background-image: linear-gradient(to top, rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.9)), url('assets/king-gym/membership-hero.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;"
        id="membership">
                        ...
                        <div
                            ...
                            <div class="modal-header border-b border-neutral-800 bg-[#0a0a0a] px-6 py-4">
                                <h5 class="modal-title font-header font-bold text-white uppercase tracking-wide text-xl"
                                    ...
                                    Metode Pembayaran <span class="text-[#f0761f] ml-1" id="membershipTitle"></span>
                                </h5>
                                <button type="button"
                            ...
                            <div class="modal-body p-6">
                                <div id="paymentOptions">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div onclick="selectPaymentMethod('qris')"
                                            class="cursor-pointer bg-neutral-900 border border-neutral-700 hover:border-[#f0761f]/50 hover:shadow-lg hover:shadow-[#f0761f]/20 rounded-lg p-5 text-center transition-all duration-300 group flex flex-col items-center justify-center min-h-[160px]">
                                            <img src="/assets/img/pembayaran/qris.png" alt="QRIS"
                                ...
                                <div id="qrisPayment" class="d-none">
                                    <h5 class="text-center font-bold text-white mb-4">
                                        Scan QRIS <span class="text-[#f0761f] block text-sm mt-1"
                                    ...
                                    <div class="flex justify-center mb-4">
                                        <div
                                            ...
                                            <img src="/assets/img/pembayaran/qris-barcode.png" alt="QRIS Barcode"
                                                class="img-fluid w-full" loading="lazy" />
                                        </div>
                                    </div>
                                    <p class="text-center text-sm text-gray-400 mb-6">Scan kode QR di atas menggunakan
                                        aplikasi m-Banking atau e-Wallet.</p>
                                    <div class="flex justify-center mb-6">
                                        <button
                                            class="bg-[#f0761f] hover:bg-[#d86819] text-white font-bold py-2.5 px-6 rounded shadow-lg shadow-[#f0761f]/30 transition transform hover:-translate-y-0.5"
                                ...
                                <div id="transferPayment" class="d-none">
                                    <h5 class="text-center font-bold text-white mb-4">
                                        Transfer Bank <span class="text-[#f0761f] block text-sm mt-1"
                                            id="transferMembershipTitle"></span>
                                    </h5>
                                    <div
                                        class="bg-neutral-900 border border-neutral-700 rounded-xl p-5 mb-4 text-center">
                                        <img src="/assets/img/pembayaran/bca.png" alt="Bank BCA"
                                            class="h-12 mx-auto mb-3 object-contain" loading="lazy" />
                        ...
                        <div
                            ...
                            <div class="modal-header border-b border-neutral-800 bg-[#0a0a0a] px-6 py-4">
                                <h5 class="modal-title font-header font-bold text-white uppercase tracking-wide text-xl"
                                    ...
                                    Konfirmasi <span class="text-[#f0761f]">Pembayaran</span>
                                </h5>
                                <button type="button"
                                    class="btn-close btn-close-white opacity-50 hover:opacity-100 transition"
                                    data-bs-dismiss="modal" aria-label="Close"></button>
                                ...
                                <form id="paymentForm" enctype="multipart/form-data" class="space-y-4">
                                    ...
                                    <div
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="name" placeholder="Sesuai KTP / Panggilan"
                                                class="w-full bg-neutral-900 border border-neutral-700 rounded p-2.5 text-white focus:border-[#f0761f] focus:ring-1 focus:ring-[#f0761f] transition text-sm"
                                                required>
                                        </div>
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <select name="membership_type"
                                                class="w-full bg-neutral-900 border border-neutral-700 rounded p-2.5 text-white focus:border-[#f0761f] focus:ring-1 focus:ring-[#f0761f] transition text-sm cursor-pointer"
                                                required>
                                    ...
                                    <div>
                                        ...
                                        <input type="file" name="image" accept="image/png,image/jpeg,image/jpg"
                                            class="block w-full text-sm text-gray-400 file:mr-4 file:py-2.5 file:px-4 file:rounded file:border-0 file:text-xs file:font-bold file:bg-neutral-800 file:text-[#f0761f] hover:file:bg-neutral-700 cursor-pointer border border-neutral-700 rounded bg-neutral-900"
                                            required>
                                    </div>
                                    <div class="flex justify-end gap-3 pt-4 mt-2 border-t border-neutral-800">
                                        ...
                                        <button type="submit"
                                            class="bg-[#f0761f] hover:bg-[#d86819] text-white font-bold py-2 px-6 rounded transition shadow-lg shadow-[#f0761f]/30 text-sm">Upload
                                            Bukti</button>
                                    </div>
                                </form>
                            </div>
    ...
    {{-- STORE --}}
    @if ($store)
        <section class="header mx-auto px-4 py-15 bg-black" id="store"
                    ...
                    <div class="swiper-slide">
                        <div class="client__card">
                            <img src="{{ filter_var($testimoni->image, FILTER_VALIDATE_URL) ? $testimoni->image : asset('storage/' . $testimoni->image) }}"
                                alt="{{ $testimoni->name }}" loading="lazy" decoding="async" />
                            <div><i class="ri-double-quotes-r"></i></div>
                            <p>{{ $testimoni->description }}</p>
                            <h4>{{ $testimoni->name }}</h4>
                            <div class="rating">
                                @php $rating = $testimoni->rating ?? 1; @endphp
                                @for ($i = 1; $i <= 5; $i++)
                                    <i
                        ...
                        <div class="blog__card mt-4 md:mt-0">
                            <a href="{{ route('blogs.show', $item->slug) }}">
                                <img src="{{ asset('storage/' . $item->image) }}" alt="{{ $item->title }}"
                                    class="h-[300px] w-full object-cover" loading="lazy" decoding="async" />
                                <p class="uppercase text-[10px] tracking-[3px] mb-1 text-white mt-3">
                                    {{ $item->created_at->format('F d, Y') }}</p>
                                <h4 class="text-lg font-medium uppercase">{{ $item->title }}</h4>
                            </a>
                        </div>
                    @endforeach
                </div>
    ...
    @endsection {{-- Pastikan menutup tag section jika ada logika template --}}

    {{-- MAPS EMBED --}}
    <section class="w-full mx-auto" id="contact">
        <div style="width: 100%; height: 300px;">
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3956.3990886005636!2d109.2682165745483!3d-7.421008173094577!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e655f0048b6a975%3A0x8d16ddcbd80dad18!2sK1NG%20GYM!5e0!3m2!1sid!2sid!4v1735265555471!5m2!1sid!2sid"
                style="border:0; width: 100%; height: 100%" allowfullscreen="" loading="lazy"
                referrerpolicy="no-referrer-when-downgrade" title="Google Maps K1NG Gym"></iframe>
        </div>
    </section>
        ...
        <div class="footer__container max-w-[1200px] mx-auto px-4 py-20">
            <div class="footer__col">
                <div class="footer__logo">
                    <a href="#">
                        <img src="{{ asset('assets/Logo/last.png') }}" alt="K1NG Gym Logo" loading="lazy" />
                    </a>
                </div>
                <p>Selamat datang di K1NG Gym Purwokerto, pusat kebugaran populer di Kaliputih, Kec. Purwokerto Tim.</p>
                <ul class="footer__links">
                    ...
                    <li>
                        <a href="https://wa.me/6283194288423" target="_blank" rel="noopener noreferrer">
                            <span><i class="ri-phone-fill"></i></span>
                            +62 831 9428 8423
                        </a>
                    </li>
                    <li>
                        <a href="mailto:sobiin77@gmail.com" target="_blank" rel="noopener noreferrer">
            ...
            <div class="footer_contact text-white">
                ...
                <div class="border-b border-dotted border-gray-400 pb-3 mb-3 group">
                    <a href="https://www.threads.net/@biin_gym?xmt=AQGzKh5EYkbE4G7JIjSwlirbjIADsXrxWWU6UuUKi1XKhFU"
                        class="flex items-center gap-3 text-white group-hover:text-yellow-600 transition-all"
                        target="_blank" rel="noopener noreferrer">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                            class="bi bi-threads group-hover:text-yellow-600" viewBox="0 0 16 16">
                            <path
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (btn && menu) {
                btn.addEventListener('click', () => {
                    ...
                    if (isHidden) {
                        ...
                        iconTimes.classList.replace('scale-100', 'scale-0');
                        iconTimes.classList.replace('opacity-100', 'opacity-0');
                    } else {
                        iconBars.classList.replace('scale-100', 'scale-0');
                        iconBars.classList.replace('opacity-100', 'opacity-0');
                        iconTimes.classList.replace('scale-0', 'scale-100');
                        iconTimes.classList.replace('opacity-0', 'opacity-100');
                    }
                });
            }
                ...
                sections.forEach(section => {
                    ...
                    if (rect.top <= 100 && rect.bottom >= 100 && !activeFound) {
                        ...
                        navItems.forEach(item => {
                            item.classList.toggle('active', item.querySelector('a').getAttribute(
                                'href') === `#${id}`);
                        });
                    }
                });
            ...
            const galleryData = Array.from(thumbnails).map((t, index) => ({
        ...
        document.getElementById('paymentForm').addEventListener('submit', function(event) {
            ...
            fetch('/payment/upload', {
                ...
                .catch(error => {
                    ...
                    if (error.errors) {
                        errorMessage = "Gagal Validasi:<br>";
