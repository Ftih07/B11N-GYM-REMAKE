...
<body>
	...
	<section class="membership"
		style="
           ...
           url('assets/king-gym/membership-hero.jpg');
           background-size: cover;
          background-position: center center;
           background-repeat: no-repeat;
       " id="membership">
							...
							<div class="modal-body p-6">
								...
								<div id="paymentOptions">
									...
									<div class="grid grid-cols-2 gap-4">
										{{-- Card Pilihan QRIS --}}
										<div onclick="selectPaymentMethod('qris')" class="cursor-pointer bg-neutral-900 border border-neutral-700 hover:border-[#f0761f]/50 hover:shadow-lg hover:shadow-[#f0761f]/20 rounded-lg p-5 text-center transition-all duration-300 group flex flex-col items-center justify-center min-h-[160px]">
										...
										<div onclick="selectPaymentMethod('transfer')" class="cursor-pointer bg-neutral-900 border border-neutral-700 hover:border-[#f0761f]/50 hover:shadow-lg hover:shadow-[#f0761f]/20 rounded-lg p-5 text-center transition-all duration-300 group flex flex-col items-center justify-center min-h-[160px]">
								...
								<div id="qrisPayment" class="d-none">
									<h5 class="text-center font-bold text-white mb-4">
										Scan QRIS <span class="text-[#f0761f] block text-sm mt-1" id="qrisMembershipTitle"></span>
									</h5>
									...
									<div class="flex justify-center mb-6">
										<button class="bg-[#f0761f] hover:bg-[#d86819] text-white font-bold py-2.5 px-6 rounded shadow-lg shadow-[#f0761f]/30 transition transform hover:-translate-y-0.5" onclick="showPaymentConfirmationModal()">
									...
									<p class="text-gray-400 text-center rounded-md bg-neutral-900 text-xs border border-neutral-800 p-3 mb-4">
										Jangan lupa absen saat berkunjung ke <strong>K1NG Gym</strong>. Jika kamu membeli atau memperpanjang Member Bulanan, minta kartu member baru atau serahkan kartu lamamu ke kasir.
									</p>
								...
								<div id="transferPayment" class="d-none">
									<h5 class="text-center font-bold text-white mb-4">
										Transfer Bank <span class="text-[#f0761f] block text-sm mt-1" id="transferMembershipTitle"></span>
									</h5>
								...
								<form id="paymentForm" enctype="multipart/form-data" class="space-y-4">
									...
									<div class="bg-neutral-900/50 border border-neutral-800 p-4 rounded-lg space-y-4 mb-2">
										<div>
											...
											<input type="text" name="name" placeholder="Sesuai KTP / Panggilan" class="w-full bg-neutral-900 border border-neutral-700 rounded p-2.5 text-white focus:border-[#f0761f] focus:ring-1 focus:ring-[#f0761f] transition text-sm" required>
										</div>
										...
										<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
											<div>
												...
												<input type="email" name="email" placeholder="email@anda.com" class="w-full bg-neutral-900 border border-neutral-700 rounded p-2.5 text-white focus:border-[#f0761f] focus:ring-1 focus:ring-[#f0761f] transition text-sm" required>
											</div>
											<div>
												<label class="block text-xs text-gray-500 uppercase font-bold tracking-wider mb-1">
													No. WhatsApp <span class="text-red-500">*</span>
												</label>
												<input type="tel" name="phone" placeholder="08..." class="w-full bg-neutral-900 border border-neutral-700 rounded p-2.5 text-white focus:border-[#f0761f] focus:ring-1 focus:ring-[#f0761f] transition text-sm" required>
											</div>
										</div>
									</div>
									...
									<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
										<div>
											...
											<select name="membership_type" class="w-full bg-neutral-900 border border-neutral-700 rounded p-2.5 text-white focus:border-[#f0761f] focus:ring-1 focus:ring-[#f0761f] transition text-sm cursor-pointer" required>
										...
										<div>
											...
											<select name="payment" class="w-full bg-neutral-900 border border-neutral-700 rounded p-2.5 text-white focus:border-[#f0761f] focus:ring-1 focus:ring-[#f0761f] transition text-sm cursor-pointer" required>
									...
									<div>
										...
										<input type="file" name="image" accept="image/png,image/jpeg,image/jpg" class="block w-full text-sm text-gray-400 file:mr-4 file:py-2.5 file:px-4 file:rounded file:border-0 file:text-xs file:font-bold file:bg-neutral-800 file:text-[#f0761f] hover:file:bg-neutral-700 cursor-pointer border border-neutral-700 rounded bg-neutral-900" required>
									</div>
									...
									<div class="flex justify-end gap-3 pt-4 mt-2 border-t border-neutral-800">
										...
										<button type="submit" class="bg-[#f0761f] hover:bg-[#d86819] text-white font-bold py-2 px-6 rounded transition shadow-lg shadow-[#f0761f]/30 text-sm">Upload Bukti</button>
									</div>
								</form>
